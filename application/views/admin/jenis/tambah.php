<button type="button" class="btn btn-default waves-effect waves-light" data-toggle="modal" data-target="#Tambah"><span class="btn-label"><i class="fa fa-plus-square-o"></i></span>Tambah</button>
